   ...
   ////vem aqui bartolomeu 
        ...
        function fetchRoboticsNews() {
          const apiKey = "6cb1daff61e445efbb4d92ba33b29b54";
          const searchTerms = "robotics, robots, artificial intelligence";
        ...
        async function displayRoboticsNews() {
          clearContent();
...
const firebaseConfig = {
  ...
  appId: "1:252930330577:web:cd0996c535a52e2745daf0"
        ...
        if (localStorage.getItem('sender')) {
          ...
          sender = prompt('Digite o nome de usuário que deseja por favor');
